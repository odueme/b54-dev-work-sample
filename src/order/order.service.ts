        ...
        if (userOrder.length === 0) {
            ...
            cart.map(item => {
              ...
              const mailOptions = {
                ...
                subject: 'Your Order',
                text: `Hello ${newOrder.user.username} this is you ordered : Name: ${item.name} price: ${item.price} Description: ${item.description} and your total is : ${newOrder.subTotal}`
              };
